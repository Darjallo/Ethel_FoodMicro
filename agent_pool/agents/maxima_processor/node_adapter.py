# Project Ethel
# Node adapter for Maxima processor
#
...
#
# agent_pool/agents/maxima_processor/node_adapter.py

import requests
from typing import Callable, Iterator

def maxima_processor_node(
    *,
    input_key: str = "script",
    output_key: str = "maxima_results",
    url: str = "http://maxima_agent:8000/"
) -> Callable[[dict], Iterator[dict]]:
    """
    Sends `state[input_key]` (a Maxima script) to the Maxima agent
