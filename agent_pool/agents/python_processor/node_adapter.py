# Project Ethel
# Node adapter for Python processor
#
...
#
# agent_pool/agents/python_processor/node_adapter.py

import requests
from typing import Callable, Iterator

def python_processor_node(
    *,
    input_key: str = "script",
    output_key: str = "python_results",
    url: str = "http://python_agent:8000/"
) -> Callable[[dict], Iterator[dict]]:
    """
    Sends `state[input_key]` (a Python snippet) to the Python agent
