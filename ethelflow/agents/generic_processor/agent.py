...
class ProgrammaticAgent:
    ...
    def handle(self, request_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not isinstance(script, str):
            return {
                **result,
                **{"status": 400, "error": "Missing or invalid 'script'."},
            }
        ...
        try:
            ...
            if proc.returncode != 0:
                ...
                return {
                    **result,
                    **{"status": 500, "error": err, "returncode": proc.returncode},
                }
            ...
            return {
                ...
                **{
                    "status": 504,
                    "error": f"{self.lang} timed out after {self.timeout}s",
                },
            }
